 ...
 */
var copyGrasshopperReleaseFiles = module.exports.copyGrasshopperReleaseFiles = function(dest, errCode) {
    errCode = errCode || 1;
    ...
    // Delete the node_modules/gh-*/tests directories
    _.each(shell.ls(srcDir + '/node_modules/gh-*'), function(modulePath) {
        shell.rm('-rf', modulePath + '/tests');
    });

    CoreUtil.logSuccess('Successfully copied release artifacts to '.text + srcDir.white);
